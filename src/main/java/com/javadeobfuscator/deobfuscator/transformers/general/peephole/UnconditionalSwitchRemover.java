...
public class UnconditionalSwitchRemover extends Transformer {
    public UnconditionalSwitchRemover(Map<String, WrappedClassNode> classes, Map<String, WrappedClassNode> classpath) {
